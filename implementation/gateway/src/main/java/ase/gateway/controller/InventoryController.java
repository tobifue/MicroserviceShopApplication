...
public class InventoryController {
    ...
    /**
     * @return format of {"items":[{"name": string, "quantity": number, "price": number, "vendor": string, "priceRecommendation": number}]}
     */
    ...
    /**
     * @param item in format { "item" : {"vendor" : "2", "price" : "10", "quantity" : "1", "priceRecommendation" : "1"}} }
     * @return (" { \ " command \ " : \ " Okay \ " } ") or ("{ \"command\":\"Error\"}")
     */
